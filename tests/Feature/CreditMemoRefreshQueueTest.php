...
it('dispatches only due active registered customers', function () {
    Queue::fake();
    Company::factory()->create(['id' => 17, 'is_active' => true, 'credit_memos_next_sync_at' => now()]);
    Company::factory()->create(['id' => 18, 'is_active' => false]);
    Company::factory()->create(['id' => 19, 'is_active' => true, 'credit_memos_next_sync_at' => now()->addMinute()]);
