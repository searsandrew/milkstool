...
{
    protected $signature = 'milkstool:token:issue {client : Lowercase client slug} {--activity : Allow recording activity for granted customers} {--days=90 : Token lifetime in days} {--customer=* : Grant transaction reads for these NetSuite IDs, or all for a trusted service}';
    ...
    public function handle(): int
    {
        $validator = Validator::make([
            ...
            'customers' => ['array', ...($this->option('activity') ? ['min:1'] : [])],
